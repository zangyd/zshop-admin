<template>
  <el-form
    ...
    <div v-permission="'/setting/setting/system/upload/zshop'">
      <el-divider>zshop(本地上传)</el-divider>

      <el-form-item
        :label="form.zshop_url.description"
        prop="zshop_url">
        <el-input
          v-model="form.zshop_url.value"
          :placeholder="form.zshop_url.description"
          :clearable="true"/>
        <div class="help-block" v-html="form.zshop_url.help_text"></div>
      </el-form-item>
    </div>
